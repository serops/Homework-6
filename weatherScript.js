...
//  **********************  UV index section ends here *********************************
    ...
    var tempDayThree= Math.round(forecastWeather.list[24].main.temp);
...
// ***************When we search for other cities, the following section handles the results. Search section starts from here************************
$("#searchBtn").on("click", runQuery);
...
addHistory();
  // clearing from the history list*******************
  let clear =function(){$("#citySearch").val("")};
  clear();
...
// **********************************************************************************************
  ...
  // *********The following section is the code for selecting the cities from search history************

  $(".list-group").on('click',"li", function(){
    let cityText=$(this).text()
    let city= cityText.slice(0, -7);
    console.log(city);
...
// // innerWidth 575 should triger removal of the class collapse  
